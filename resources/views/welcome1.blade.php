              ...
              <div class="col-sm-7">
                <div class="text-area">
                  <div class="position-center-center col-md-10">
                    <h1 style="color: white"> Here comes the social networking platform that you’ve been waiting for</h1>
                    <h6 style="color: white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue conseqaut nibbhi ellit ipsum consectetur. </h6>
                  </div>
                </div>
              </div>
